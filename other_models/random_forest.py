...
df['shot_outcome'] = df['shot_outcome'].replace(
    ['Saved', 'Saved Off Target', 'Saved to Post'], 'Saved'
)

# 3) Define features/target
features = [
    'location_x','location_y','shot_distance','shot_angle','num_defenders','min_defender_dist','defender_density_2m',
...
# 7) Preprocess training & test data
